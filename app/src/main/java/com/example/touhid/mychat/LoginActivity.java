...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginEmail = (EditText) findViewById(R.id.login_email_field);
        loginPassword = (EditText) findViewById(R.id.login_password_field);
